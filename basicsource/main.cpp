...
void drawScene(void)
{
	...
	if ((gCurrentFrameTime >= 2) && (gCurrentFrameTime <= 5))
		showCopyright("2021", "youtube", "Sound Effects Library", "Mario Kart Race Start -traffic light beeping");

	if ((gCurrentFrameTime >= 12) && (gCurrentFrameTime <= 20))
		showCopyright("2021", "youtube", "Sound Effects Library","Traffic Noise Sound Effect");
